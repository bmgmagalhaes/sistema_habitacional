...
class PontuacaoServico:
    ...
    def calcular(beneficiario):
        ...
        for criterio in criterios:
            ...
            valor = getattr(beneficiario, criterio.campo_beneficiario, None)
    ...
    def reprocessar():
        ...
        # não estejam vinculados a seleções homologadas: CONTEMPLADOS
        ...
        for beneficiario in beneficiarios:
            ...
            beneficiario.save(update_fields=["pontuacao"])

            total_recalculado += 1

        return total_recalculado
